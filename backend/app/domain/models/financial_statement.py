...
class FinancialStatement(TimestampMixin, Base):
    ...
    # === 会計期間 ===
    cur_per_type: Mapped[str | None] = mapped_column(String(20), comment="会計期間種別（1Q/2Q/3Q/FY等）")
    ...
    cfo: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="営業キャッシュフロー（百万円）")
    cfi: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="投資キャッシュフロー（百万円）")
    cff: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="財務キャッシュフロー（百万円）")
    cash_eq: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="現金及び現金同等物（百万円）")
    ...
    div_total_ann: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="年間配当総額（百万円）")
    payout_ratio_ann: Mapped[Decimal | None] = mapped_column(Numeric(5, 2), comment="配当性向（%）")

    # === 配当情報（予想） ===
    f_div_1q: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="第1四半期配当金予想（円）")
    f_div_2q: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="第2四半期配当金予想（円）")
    f_div_3q: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="第3四半期配当金予想（円）")
    f_div_fy: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="期末配当金予想（円）")
    f_div_ann: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="年間配当金予想（円）")
    f_div_unit: Mapped[str | None] = mapped_column(String(20), comment="配当単位・予想")
    f_div_total_ann: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="年間配当総額予想（百万円）")
    f_payout_ratio_ann: Mapped[Decimal | None] = mapped_column(Numeric(5, 2), comment="配当性向予想（%）")

    # === 当期業績予想（連結） ===
    f_sales_2q: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="売上高予想・第2四半期末（百万円）")
    f_op_2q: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="営業利益予想・第2四半期末（百万円）")
    f_od_p_2q: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="経常利益予想・第2四半期末（百万円）")
    f_np_2q: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="当期純利益予想・第2四半期末（百万円）")
    f_eps_2q: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="EPS予想・第2四半期末（円）")
    f_sales: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="売上高予想・期末（百万円）")
    f_op: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="営業利益予想・期末（百万円）")
    f_od_p: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="経常利益予想・期末（百万円）")
    f_np: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="当期純利益予想・期末（百万円）")
    ...
    nx_f_op: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="営業利益予想・翌事業年度期末（百万円）")
    ...
    nx_f_eps: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="EPS予想・翌事業年度期末（円）")
    ...
    nx_f_div_fy: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="期末配当金予想・翌事業年度（円）")
    nx_f_div_ann: Mapped[Decimal | None] = mapped_column(
        Numeric(10, 2), comment="年間配当金予想・翌事業年度（円）"
    )
    nx_f_div_unit: Mapped[str | None] = mapped_column(String(20), comment="配当単位・翌事業年度予想")
    nx_f_payout_ratio_ann: Mapped[Decimal | None] = mapped_column(
        Numeric(5, 2), comment="配当性向予想・翌事業年度（%）"
    )

    # === 非連結データ（実績） ===
    nc_sales: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="売上高・非連結（百万円）")
    nc_op: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="営業利益・非連結（百万円）")
    nc_od_p: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="経常利益・非連結（百万円）")
    nc_np: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="当期純利益・非連結（百万円）")
    nc_eps: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="EPS・非連結（円）")
    nc_ta: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="総資産・非連結（百万円）")
    nc_eq: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="純資産・非連結（百万円）")
    nc_eq_ar: Mapped[Decimal | None] = mapped_column(Numeric(5, 2), comment="自己資本比率・非連結（%）")
    ...
    nc_f_sales: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="売上高予想・期末・非連結（百万円）")
    nc_f_op: Mapped[Decimal | None] = mapped_column(Numeric(17, 2), comment="営業利益予想・期末・非連結（百万円）")
    ...
    nc_f_eps: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), comment="EPS予想・期末・非連結（円）")
    ...
    chg_by_as_rev: Mapped[str | None] = mapped_column(String(255), comment="会計基準の改訂による変更")
    chg_no_as_rev: Mapped[str | None] = mapped_column(String(255), comment="会計基準の改訂以外による変更")
    ...
    __table_args__ = (
        ...
        # 銘柄別の最新データ取得用インデックス
        Index("idx_financial_statements_code_date", "stock_code", "disc_date", postgresql_using="btree"),
        # 日付順ソート用インデックス
